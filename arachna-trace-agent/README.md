...
The Java bytecode-instrumentation agent — the producer side of Arachna Trace.
...
For solution-level context (what Arachna Trace is and why), see
[../README.md](../README.md). For the language-neutral wire-format contract
that any Arachna Trace agent must implement, see [docs/spec/SPEC.md](docs/spec/SPEC.md).
