...
Thank you for your interest in DeepFlow. This document describes the
project's scope, where contribution is most welcome, and how to get a
change merged.

## Project scope

DeepFlow is a **runtime tracing substrate**: a Java agent captures
...
DeepFlow's wire format is language-neutral
...
The UI is in `deepflow-ui/` (Vue 3 + TypeScript). Features that match
...
- **Performance / APM features.** DeepFlow is a debugging and audit
