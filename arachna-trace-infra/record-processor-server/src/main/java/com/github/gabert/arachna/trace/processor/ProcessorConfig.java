...
public class ProcessorConfig {
    ...
    private static final String DEFAULT_KAFKA_TOPIC = "arachna-trace-records";
    private static final String DEFAULT_KAFKA_GROUP_ID = "arachna-trace-processor";
    private static final String DEFAULT_CLICKHOUSE_URL = "http://localhost:8123";
    private static final String DEFAULT_CLICKHOUSE_DATABASE = "arachna_trace";
    private static final String DEFAULT_CLICKHOUSE_USER = "arachna_trace";
    private static final String DEFAULT_CLICKHOUSE_PASSWORD = "arachna_trace";
